...
## Project Structure
    ...
    ├── revelations_cleanin_37168  # Django project configurations
...
1. Clone this repo and `cd revelations_cleanin_37168`
...
2. Clone this repo and `cd revelations_cleanin_37168`
